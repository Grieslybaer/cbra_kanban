...
ActiveRecord::Schema.define(version: 20160620185118) do
  ...
  add_index "account_users", ["email"], name: "index_account_users_on_email", unique: true
  add_index "account_users", ["reset_password_token"], name: "index_account_users_on_reset_password_token", unique: true
